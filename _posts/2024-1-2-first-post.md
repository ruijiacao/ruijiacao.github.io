...
The key to this problem is the observation that for any $$x \in V$$ there exists $$\delta_x > 0$$ such that the open ball $$B_{\delta_x}(x) \subseteq V$$ and $B_{\delta_x}$ is an open set.   
